...
module Data.Binary.Encoding.Word
    ...
    -- for lists of words. Using these list serialization functions is /much/
    -- faster than using @mconcat . map fromWord/<n/>@, as the list
    -- serialization functions use a tighter inner loop.
...
import Data.Binary.Encoding.Storable
